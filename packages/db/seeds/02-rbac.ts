...
export const RBAC_PERMISSION_CATALOG: PermissionSeed[] = [
  ...
  { code: 'report.read', description: 'Read daily reports + checklist + KPI compliance' },
  { code: 'report.submit', description: 'Create daily report drafts, fill checklist, submit' },
  { code: 'report.validate', description: 'Validate or reject submitted daily reports' },
  { code: 'report.item_manage', description: 'Manage report checklist master items' },
  { code: 'evidence.upload', description: 'Request upload URL, confirm uploads, and delete pending evidence' },
  { code: 'evidence.read', description: 'List evidence metadata and request view URLs' },
