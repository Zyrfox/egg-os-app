...
const CORE_SEED = {
  ...
  brands: [
    { brandCode: 'BTMK', brandName: 'Back To Mie Kitchen',     brandType: 'fnb',          isActive: true  },
    { brandCode: 'BTMF', brandName: 'Back To Mie Forest',      brandType: 'fnb',          isActive: true  },
    { brandCode: 'TSF',  brandName: 'Taman Sari Forest',       brandType: 'tourism',      isActive: true  },
    { brandCode: 'ENC',  brandName: 'Easee n Co',              brandType: 'retail',       isActive: true  },
    { brandCode: 'EGC',  brandName: 'Easy Going Construction', brandType: 'construction', isActive: true  },
    { brandCode: 'FRC',  brandName: 'Fi Amanillah Rent Car',   brandType: 'rental',       isActive: true  },
    { brandCode: 'BHG',  brandName: 'Brotherhood Garage',      brandType: 'automotive',   isActive: true  },
    { brandCode: 'HCP',  brandName: 'Healthopia',              brandType: 'healthcare',   isActive: false },
  ],
  outlets: [
    {
      brandCode: 'BTMK',
      outletCode: 'BTMK-01',
      outletName: 'Back To Mie Kitchen Outlet 01',
      outletType: 'pilot',
    ...
    },
    {
      brandCode: 'BTMF',
      outletCode: 'BTMF-01',
      outletName: 'Back To Mie Forest Outlet 01',
      outletType: 'pilot',
      timezone: 'Asia/Jakarta',
    },
  ],
